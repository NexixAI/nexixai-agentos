...
## 8) LatticeOS Framework

This project implements the [LatticeOS](../nexixai-latticeos/README.md) multi-agent development framework.

- **Drift resolution:** Follow [sync-protocol.md](../nexixai-latticeos/process/sync-protocol.md) — tier hierarchy determines which artifact to fix
- **Spec conflicts:** Follow [conflict-resolution.md](../nexixai-latticeos/process/conflict-resolution.md) — human decides, decision record produced
